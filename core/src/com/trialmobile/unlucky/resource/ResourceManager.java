...
import com.trialmobile.unlucky.map.World;
...
public class ResourceManager {
    ...
    // OfferWall Menu
    public TextureRegion videoAdIcon;
    public TextureRegion offerWallIcon;
    ...
    public ResourceManager() {
        ...
        // load font
//        uiFont = new BitmapFont(Gdx.files.internal("fonts/pixel.fnt"), atlas.findRegion("pixel"), false);
        pixel10 = new BitmapFont(Gdx.files.internal("fonts/dung.fnt"), false);
        ...
        dialogSkin.getFont("default-font").getData().setScale(0.5f);
        ...
        // offerWall
        Texture offerWallTexture = new Texture("offerwall.png");
        offerWallIcon = new TextureRegion(offerWallTexture, 0, 0, 32, 32);
        Texture videoAdTexture = new Texture("advertising.png");
        videoAdIcon = new TextureRegion(videoAdTexture, 0, 0, 32, 32);
    ...
    public void loadByLang() {
        Preferences prefs = Gdx.app.getPreferences("Unlucky Preference");

        String langCode = prefs.getString("lang", "ko");
        locale = new Locale(langCode);
        if (locale.toString().substring(0, 2).equalsIgnoreCase("ko")) {
            lang = "_ko";
        } else {
            lang = "";
        }
        ...
        Util.S_DISTRACT.setNameAndDescription(bundle.get("Distract"), bundle.format("Distract_DESCRIPTION", Util.P_DISTRACT));
        Util.S_FOCUS.setNameAndDescription(bundle.get("Focus"), bundle.format("Focus_DESCRIPTION", Util.P_FOCUS_CRIT));
        Util.S_INTIMIDATE.setNameAndDescription(bundle.get("Intimidate"), bundle.format("Intimidate_DESCRIPTION", Util.P_INTIMIDATE));
        Util.S_REFLECT.setNameAndDescription(bundle.get("Reflect"), bundle.get("Reflect_DESCRIPTION"));
        Util.S_STUN.setNameAndDescription(bundle.get("Stun"), bundle.format("Stun_DESCRIPTION", Util.P_STUN));
        Util.S_INVERT.setNameAndDescription(bundle.get("Invert"), bundle.get("Invert_DESCRIPTION"));
        Util.S_SACRIFICE.setNameAndDescription(bundle.get("Sacrifice"), bundle.get("Sacrifice_DESCRIPTION"));
        Util.S_SHIELD.setNameAndDescription(bundle.get("Shield"), bundle.format("Shield_DESCRIPTION"));
    }
    ...
    private void loadWorlds() {
        // parse worlds.json
        JsonValue base = jsonReader.parse(Gdx.files.internal("maps/worlds"+lang+".json"));
    ...
    private void loadMoves() {
        // parse moves.json
        JsonValue base = jsonReader.parse(Gdx.files.internal("moves/moves"+lang+".json"));
        JsonValue boss = jsonReader.parse(Gdx.files.internal("moves/boss_moves"+lang+".json"));
    ...
    private void loadItems() {
        // parse items.json
        JsonValue itemPool = jsonReader.parse(Gdx.files.internal("items/items"+lang+".json"));
        // parse shopitems.json
        JsonValue shopitemPool = jsonReader.parse(Gdx.files.internal("items/shopitems"+lang+".json"));
