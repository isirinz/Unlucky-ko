    ...
    public void render(float dt) {
        ...
        if (shouldStart) {
            switch (transitionIndex) {
                ...
                case 2:
                    for (int i = 0; i < 8; i++) {
                        if (i % 2 == 0) shapeRenderer.rect(x0, i * 30, -Unlucky.V_WIDTH, 30);
                        else shapeRenderer.rect(x1, i * 30, Unlucky.V_WIDTH, 30);
                    }
                    break;
                // vertical strips (width: 200 = 10 stripes of width 20)
                case 3:
                    for (int i = 0; i < 10; i++) {
                        if (i % 2 == 0) shapeRenderer.rect(i * 40, y0, 40, -Unlucky.V_HEIGHT);
                        else shapeRenderer.rect(i * 40, y1, 40, Unlucky.V_HEIGHT);
                    }
                    break;
                // horizontal split
                case 4:
